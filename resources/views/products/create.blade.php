            ...
            <form action="{{ route('products.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="location_id" id="location_id"
                            ...
                            @foreach($warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}" {{ old('location_id') == $warehouse->id ? 'selected' : '' }}>
                                    {{ $warehouse->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="dimensions" id="dimensions" value="{{ old('dimensions') }}" placeholder="e.g., 10x20x30"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="value" id="value" value="{{ old('value', 0) }}"
